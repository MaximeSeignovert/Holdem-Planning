...
const Sidebar = () => {
  ...
  return (
    <div className='hidden sm:flex relative h-full'>
        <div className={`flex h-full ${isExpanded ? 'w-64' : 'w-[70px]'}  items-center z-10 bg-menu-background border-r shadow flex-col transition-width duration-300 ease-in-out`}>
